...
export default class PastelIdHome extends Component {
  render () {
    return <MainWrapper>
      <Switch>
      ...
      <p className={style['blockchain-data']}>Your wallet address is <span>{this.props.blockchainAddress}</span></p>
      <p className={style['blockchain-data']}>
        Network has <span>{this.props.masternodes}</span> masternodes and <span>{this.props.artworks}</span> artworks
      </p>
    </MainWrapper>;
  }
}
