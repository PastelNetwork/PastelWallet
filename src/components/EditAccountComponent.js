                                ...
                                <div className="flat-card upload-card is-auto">
                                    <div className="card-body">
                                        ...
                                        <div id="avatar-upload" className="avatar-wrapper has-simple-popover"
                                            ...
                                            <img className="profile-pic" src="http://via.placeholder.com/250x250"
                                                 alt=""/>
                                                <div className="upload-button">
                                                    <i className="upload-icon" data-feather="plus"
                                                       aria-hidden="true"></i>
                                                </div>
                            ...
                            <div className="column is-8">
                                    ...
                                    <div className="card-title">
                                        ...
                                        <div className="confirm-button">
                                            <a href="javascript:void(0);" role="button" className="has-simple-popover"
                                               data-content="Save Contact info" data-placement="top"><i
                                                className="feather-icons" data-feather="check"></i></a>
                                        </div>
                                    </div>
                                    <div className="card-body">
                                        <div className="columns">
                                            ...
                                            <div className="column is-6">
                                                ...
                                                <div className="info-block">
                                                    ...
                                                    <div className="control">
                                                        <input type="text" className="input is-default"
                                                               value="+1 555 623 568"/>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="flat-card profile-info-card is-auto has-overflow">
                                    ...
                                    <div className="card-title">
                                        ...
                                        <div className="confirm-button">
                                            <a href="javascript:void(0);" role="button" className="has-simple-popover"
                                               data-content="Save Addresses" data-placement="top"><i
                                                className="feather-icons" data-feather="check"></i></a>
                                        </div>
                                    </div>
                                    <div className="card-body">
                                ...
                                <div className="flat-card profile-info-card is-auto has-overflow">
                                    <div className="card-title">
                                        ...
                                        <div className="switch-wrapper has-simple-popover"
                                             data-content="Enable if you need a different shipping address"
                                             data-placement="top">
